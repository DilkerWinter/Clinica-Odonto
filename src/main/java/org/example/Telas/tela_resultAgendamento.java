 ...
 * @author winter
 */
public class tela_resultAgendamento extends javax.swing.JFrame {

    /**
     * Creates new form tela_resultAgendamento
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tela_resultAgendamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new tela_resultAgendamento().setVisible(true);
            }
        });
    }
